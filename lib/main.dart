...
Future<void> restaurarBackupCompleto(String backupJson) async {
  ...
  for (final entry in data.entries) {
    if (entry.key.startsWith('roster_') && entry.value != null) {
      await prefs.setString(
        entry.key,
        sanitizeImportedJsonText(entry.value),
      );
    }
  }
}
